...
import org.fisco.bcos.sdk.utils.exceptions.DecodingException;
import org.fisco.bcos.sdk.utils.exceptions.EncodingException;
...
public final class Numeric {
    ...
    public static String encodeQuantity(BigInteger value) throws EncodingException {
        if (value.signum() != -1) {
    ...
    public static BigInteger decodeQuantity(String value) {
        if (!isValidHexQuantity(value)) {
            ...
            try {
                ...
                throw new DecodingException("value is not a hex number or a decimal number");
            }
        }
    }
