...
contract ComplexSol{
        ...
        constructor(int i, string s) public {
            _addr = msg.sender;
            _intV = i;
            _s = s;
        ...
        function setValues(int i, address[] a, string s) public {
            _intV = i;
            _addrDArray = a;
            _s = s;
        ...
        function setBytes(bytes b) public returns (bytes) {
        ...
        function getByBytes(bytes b) public view returns (bytes[]) {
            return _bytesMapping[b];
        }
      
         function getSArray() public returns (uint256[2]){
