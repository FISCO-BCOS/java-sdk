...
import org.fisco.bcos.sdk.contract.ComplexCodecTest;
...
public class CodecComplexTest {
    ...
    public void test1ComplexCodecWithType() throws Exception {
        ...
        Assert.assertEquals(complexCodecTest.getDeployReceipt().getStatus(), "0x0");
        ...
        // test bytes[][] set and get
        {
            ...
            Assert.assertEquals(transactionReceipt.getStatus(), "0x0");
            Tuple1<List<List<byte[]>>> setBytesArrayArrayOutput =
                    complexCodecTest.getSetBytesArrayArrayOutput(transactionReceipt);
            byte[] bytes = setBytesArrayArrayOutput.getValue1().get(0).get(0);
            Assert.assertEquals(
        ...
        {
            byte[] b =
                    org.fisco.bcos.sdk.utils.Hex.decode(
        ...
        {
            byte[] b1 = org.fisco.bcos.sdk.utils.Hex.decode("ffffffff1234567890123456ffffffffffffffff1234567890123456ff111111");
        ...
        */
        ...
        // test static struct set and get
        {
            ...
            Assert.assertEquals(transactionReceipt1.getStatus(), "0x0");
