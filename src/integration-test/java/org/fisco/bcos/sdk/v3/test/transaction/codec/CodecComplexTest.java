...
public class CodecComplexTest {
    ...
    public void test1ComplexCodecWithType() throws Exception {
        ...
        ComplexCodecTest complexCodecTest =
                ComplexCodecTest.deploy(client, client.getCryptoSuite().getCryptoKeyPair(), new ComplexCodecTest.StructA(
        ...
        // test call get struct
        {
            ...
            List<ComplexCodecTest.StructA> structA1 = complexCodecTest.getStructA(new ComplexCodecTest.StructA(
                    stringList, bytes
            ));
            ...
            Assert.assertEquals(Hex.toHexString(structA1.get(1).bytes32_in_struct.get(0)), bytes32Str);
        }
        ...
        // test bytes[][] set and get
        {
            ...
            Tuple1<List<List<byte[]>>> setBytesArrayArrayOutput = complexCodecTest.getSetBytesArrayArrayOutput(transactionReceipt);
        ...
        // test bytes32[][] set and get
        {
            ...
            Assert.assertEquals(transactionReceipt.getStatus(), 0);
            Tuple1<List<List<byte[]>>> setBytes32ArrayArrayOutput = complexCodecTest.getSetBytes32ArrayArrayOutput(transactionReceipt);
        ...
        */
        ...
        // test bytes32[2][] set and get
        {
            ...
            List<List<byte[]>> bss = new ArrayList<>();
            bss.add(bs);
            TransactionReceipt transactionReceipt = complexCodecTest.setBytes32StaticArrayArray(bss);
            Assert.assertEquals(transactionReceipt.getStatus(), 0);
            Tuple1<List<List<byte[]>>> setBytes32StaticArrayArrayOutput = complexCodecTest.getSetBytes32StaticArrayArrayOutput(transactionReceipt);
        ...
        // test struct set and get
        {
            ...
            TransactionReceipt transactionReceipt = complexCodecTest.buildStructB(new ComplexCodecTest.StructA(arrays, bytes32DynamicArrays));
            Assert.assertEquals(transactionReceipt.getStatus(), 0);
            Tuple2<ComplexCodecTest.StructB, DynamicArray<ComplexCodecTest.StructA>> buildStructBOutput = complexCodecTest.getBuildStructBOutput(transactionReceipt);
        ...
        // test static struct set and get
        {
            ...
            TransactionReceipt transactionReceipt = complexCodecTest.buildStaticStruct(
            ...
            Tuple1<DynamicArray<ComplexCodecTest.StaticStruct>> buildStaticStructInt128Uint128Output = complexCodecTest.getBuildStaticStructInt128Uint128Output(transactionReceipt1);
