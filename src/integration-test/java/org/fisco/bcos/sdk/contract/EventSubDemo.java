...
public class EventSubDemo extends Contract {
    ...
    public List<TransferDataEventResponse> getTransferDataEvents(
        ...
        for (EventValuesWithLog eventValues : valueList) {
            ...
            typedResponse.transaction_data =
                    (DynamicArray<TransactionData>) eventValues.getNonIndexedValues().get(0);
            responses.add(typedResponse);
        }
        return responses;
    }
    ...
    public byte[] echo(byte[] bsn, byte[] bs, TransactionCallback callback) {
        final Function function =
                new Function(
                        FUNC_ECHO,
                        Arrays.<Type>asList(new Bytes32(bsn), new DynamicBytes(bs)),
    ...
    public byte[] echo(BigInteger u, BigInteger i, String s, TransactionCallback callback) {
        final Function function =
                new Function(
                        FUNC_ECHO,
                        Arrays.<Type>asList(new Uint256(u), new Int256(i), new Utf8String(s)),
    ...
    public static EventSubDemo deploy(Client client, CryptoKeyPair credential)
        ...
        return deploy(
                EventSubDemo.class, client, credential, getBinary(client.getCryptoSuite()), null);
    }
