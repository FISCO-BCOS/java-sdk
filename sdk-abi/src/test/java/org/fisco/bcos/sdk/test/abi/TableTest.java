...
public class TableTest {
  ...
  */
  ...
  public void ABILoadTest() {
    ...
    Assert.assertEquals(Hex.toHexString(insert.getMethodId(Utils.getCryptoSuite())), "ebf3b24f");
    Assert.assertEquals(Hex.toHexString(remove.getMethodId(Utils.getCryptoSuite())), "c4f41ab3");
    Assert.assertEquals(Hex.toHexString(update.getMethodId(Utils.getCryptoSuite())), "487a5a10");
    Assert.assertEquals(Hex.toHexString(select.getMethodId(Utils.getCryptoSuite())), "fcd7e3c1");
